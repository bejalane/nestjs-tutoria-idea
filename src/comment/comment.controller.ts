import { Controller, Post, UseGuards, UsePipes, Get, Param, Body, Delete } from '@nestjs/common';
...
export class CommentController {
    ...
    createComment(@Param('id') ideaId: string, @User() user: UserEntity, @Body() data: CommentDTO){
